...
public class PengembalianDaoImp implements PengembalianDao{
    ...
    public void insert(Connection con, Pengembalian pengembalian) throws Exception {
        ...
        ps.setString(6, pengembalian.getTglkembalikan());
        ps.executeUpdate();
    }
    ...
    public void update(Connection con, Pengembalian pengembalian) throws Exception {
        ...
        ps.setString(4, pengembalian.getTglkembalikan());
    ...
    @Override
    public Pengembalian getPengembalian(Connection con, String kodeanggota, String kodebuku, String tglpinjam, String tglkembalikan, String terlambat, String denda) throws Exception {
        ...
        if (rs.next()) {
            ...
            pengembalian.setTglkembalikan(rs.getString(4));
    ...
    public List<Pengembalian> getAllPengembalian(Connection con) throws Exception {
        String sql = "SELECT peminjaman.kodeanggota, anggota.namaanggota, peminjaman.kodebuku, "
                + "buku.judul, peminjaman.tglpinjam, pengembalian.tgldikembalikan, pengembalian.terlambat,"
                + "pengembalian.denda "
                + "FROM peminjaman "
        ...
        while (rs.next()) {
            ...
            pengembalian.setTglkembalikan(rs.getString("tgldikembalikan"));
